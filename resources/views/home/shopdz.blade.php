        ...
        <!-- Main Container Start -->
            	...
            	<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	...
                    	<span style="color:skyblue;font-size:20px">修改收货地址</span>
                    </div>
                    	<form class="mws-form" method="post" action="/shopjs/{{$edd->id}}">
                    			{{csrf_field()}}
                    			{{method_field('PUT')}}
                    		<input type="hidden" name="user_id" value="{{$edd->user_id}}">
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">收货人</label>
                    				<div class="mws-form-item">
                    					<input type="text" name="name" class="small" value="{{$edd->name}}">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">所在省市</label>
                    				<div class="mws-form-item">
                    					<input type="text" name="huo" class="small" value="{{$edd->huo}}">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">详细地址</label>
                    				<div class="mws-form-item">
                    					<input type="text" name="adds" class="small" value="{{$edd->adds}}">
                    				</div>
                    			</div>
                    			<div class="mws-form-row">
                    				<label class="mws-form-label">联系电话</label>
                    				<div class="mws-form-item">
                    					<input type="text" name="phone" class="small" value="{{$edd->phone}}">
                    				</div>
                    			</div>
                    		</div>
                    			
                    		<div class="mws-button-row" style="background:transparent;border-top-style: none;border-bottom-style: none;">
                    			<input type="submit" value="确认修改地址" class="btn btn-success">
